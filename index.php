...
<header>
  ...
  <video playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop">
    <source src="http://localhost/iHuman/_site/media/video.mp4" type="video/mp4">
  </video>
  <div class="container h-100">
    <div class="d-flex h-100 text-center align-items-center">
      <div class="w-100 text-white">
        <h1 class="display-3"><b style="color: #F20F8C; font-weight: bold;">i</b><b style="font-weight: bold;">Human</b></h1>
        <p class="lead mb-0">
          <div class='console-container'><span class="high"><span id='text'></span><div class='console-underscore' id='console'></div></div></span>
        </p>
        <script src="http://localhost/iHuman/_site/media/js/script_terminal.js"></script>
      </div>
    </div>
  </div>
</header>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 mx-auto">
        ...
        <br>
        <br>
      <h4>A iHuman é uma Organização da Sociedade Civil, sem fins lucrativos, que ​previne e promove a saúde das pessoas com deficiência intelectual, apoia sua inclusão social, incide na defesa de seus direitos, produzindo e disseminando conhecimento.</h4>
      <br>
      <h4>Atua desde o nascimento ao processo de envelhecimento, propiciando o desenvolvimento de habilidades e potencialidades que favoreçam a escolaridade e o emprego apoiado, além de oferecer assessoria jurídica às famílias acerca dos direitos das pessoas com deficiência intelectual.</h4>
      <br>
      <center><h1 class="display-3"><b style="color: #F20F8C; font-weight: bold;">i</b><b style="font-weight: bold;">Human</b></h1></center>
      </div>
    </div>
  </div>
</section>
