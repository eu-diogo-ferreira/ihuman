...
<div class="overlay"></div>
  <div class="container contact-form">
            ...
            <form method="POST">
                <h3>Escolha a forma como deseja colaborar com doações regulares ou esporádicas.</h3>
        </form>

            <div class="row">
  <div class="col-sm-6">
    <div class="card">
    <img src="http://localhost/iHuman/_site/media/images/0_nubank.png" class="card-img-top" style="height: auto; width: 100%;">
      <div class="card-body">
        <h5 class="card-title">Doe de forma especial</h5>
        <p class="card-text">Utilize o Nubank para transações.</p>
        <a href="#" class="btn btn-primary btn-lg btn-block" style="background-color: #8806BF;">Doar</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card">
    <img src="http://localhost/iHuman/_site/media/images/0_neon.png" class="card-img-top" style="height: auto; width: 100%;">
      <div class="card-body">
        <h5 class="card-title">Doe de forma especial</h5>
        <p class="card-text">Utilize o Neon para transações.</p>
        <a href="#" class="btn btn-primary btn-lg btn-block" style="background-color: #04B2D9;">Doar</a>
      </div>
    </div>
  </div>
</div>
