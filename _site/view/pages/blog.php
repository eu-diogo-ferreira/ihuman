...
<div class="overlay"></div>
  <div class="container contact-form">
            ...
            <form method="POST">
                <h1 style="margin-bottom: 2%; margin-top: -10%; text-align: center; color: #F20F8C;">Blog<b style="color: yellow !important;">+</b></h1>
            </form>
            <a href="http://localhost/iHuman/_site/model/form_blog.php" class="btn btn-primary btn-lg btn-block" style="background-color: #04B2D9;">Fazer Post</a>

            <?php include_once('../../controller/_sel/lista_blog.php');?>
</div>
<br>
<br>
<!-- INCLUSÃO DO FOOTER -->
