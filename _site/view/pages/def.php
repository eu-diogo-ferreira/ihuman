...
<div class="overlay"></div>
  <div class="container contact-form">
            <div class="contact-image" style="transform: rotate(-29deg) !important;">
                <img src="http://localhost/iHuman/_site/media/images/heroe.png"/>
            </div>
            <form method="POST">
                <h1 style="margin-bottom: 2%; margin-top: -10%; text-align: center; color: #04D9C4;">Super-Heróis<b style="color: yellow !important;">+</b></h1>
            </form>

            <?php include_once('../../controller/_sel/lista_def.php');?>
</div>
<br>
<br>
<!-- INCLUSÃO DO FOOTER -->
