...
<div class="overlay"></div>
  <div class="container contact-form">
      ...
      <div class="card-body">
        ...
        <div class="alert alert-danger" role="alert">Ao remover usuários, os mesmos não poderão utilizar suas credenciais.</div>
        <a href="http://localhost/iHuman/_site/model/rem_user.php"><button type="button" class="btn btn-outline-danger" style="background-color: red; color: #fff;">Remover</button></a>
      </div>
    </div>
    <div class="card" style="text-align: center;">
      <div class="card-body">
        <h5 class="card-title">Remover Postagens: </h5>
        <div class="alert alert-danger" role="alert">Ao remover postagens, as mesmas não poderão ser visualizadas.</div>
        <a href="http://localhost/iHuman/_site/model/rem_post.php"><button type="button" class="btn btn-outline-danger" style="background-color: red; color: #fff;">Remover</button></a>
      </div>
    </div>
    <div class="card" style="text-align: center;">
      <div class="card-body">
        <h5 class="card-title">Adicionar ADM:</h5>
        <div class="alert alert-primary" role="alert">Ao adicionar um ADM, o mesmo poderá realizar alteraçõesno sistema.</div>
        <a href="http://localhost/iHuman/_site/model/add_adm.php"><button type="button" class="btn btn-outline-info" style="background-color: #04D9C4; color: #fff;">Adicionar</button></a>
      </div>
    </div>
  </div>        
</div>
