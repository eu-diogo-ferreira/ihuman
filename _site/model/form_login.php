      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <form class="form-signin" name="login" action="http://localhost/iHuman/_site/controller/_auth/login.php" method="POST">
              ...
              <div class="custom-control custom-checkbox mb-3">
                  ...
                  <label class="custom-control-label" for="customCheck1">Deficiente</label>
              </div>
              <div class="custom-control custom-checkbox mb-3">
                <input type="checkbox" class="custom-control-input" id="customCheck2" value="3">
                <label class="custom-control-label" for="customCheck2">Voluntário</label>
              </div>
              <div class="custom-control custom-checkbox mb-3">
                <input type="checkbox" class="custom-control-input" id="customCheck3" value="4">
                <label class="custom-control-label" for="customCheck3">Instituição</label>
              </div>-->
              <!--Fim das Check Box-->
              <div class="form-group">
							<h6 class="card-title text-center">Sou: </h6>
							<select class="form-control" name="class" name="class" required>
                <option value="1">Administrador</option>
								<option value="2">Deficiente</option>
								<option value="3">Voluntário</option>
								<option value="4">Uma Instituição</option>
							</select>
						</div>
              <button class="btn btn-lg btn-light btn-block text-uppercase" type="submit" style="background-color: #F20F8C;">Login</button>
              <hr style="background-color: #fff;">
              <a href="http://localhost/iHuman/_site/view/op_signup.php" class="btn btn-lg btn-light btn-block text-uppercase" style="background-color: yellow;">Sign Up</a>
              <hr class="my-4">
              <a href="#" class="btn btn-lg btn-facebook btn-block text-uppercase"><i class="fab fa-facebook-f mr-2"></i> Login com o Facebook</a>
            </form>
          </div>
        </div>
      </div>
