      ...
      <div class="col-sm">
        <div class="card card-signin my-5" >
          <div class="card-body" >
            ...
            <form enctype="multipart/form-data" class="form-signin" name="cad" action="http://localhost/iHuman/_site/controller/_add/cad_user_4.php" method="POST">
              ...
              <div class="form-group">
							...
							<select class="form-control" name="class" required>
                                <option value="4">Instituição ou Empresa</option>
							</select>
			  </div>
