...
if($_SESSION['email'] != true) {
	header('location:http://localhost/iHuman/_site/view/pages/blog.php');
}
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
  ...
  <div class="container contact-form">
            ...
            <form enctype="multipart/form-data" action="http://localhost/iHuman/_site/controller/_insert/insert_blog.php" method="post">
                <h3>Publicar Blog</h3>
               <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" name="txt_nome" class="form-control" placeholder="Título do post " value="" />
                        </div>
                        <div class="form-group">
                            <label>Imagem - (Apenas PNG)</label>
                            <input class="form-control" type="file" name="txt_imagem" value="" style="background-color: #F20F8C; color: #fff !important;" size="30" />
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <textarea name="txt_corpo" class="form-control" placeholder="Conteúdo de seu post " style="width: 100%; height: 150px;"></textarea>
                        </div>
                    </div>
                </div>
            </form>
