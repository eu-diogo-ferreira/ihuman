...
<div class="overlay"></div>
  <div class="container contact-form">
		...
		<div class="container">
        <br>
        <a href="http://localhost/iHuman/_site/view/admin.php"><button type="button" class="btn btn-outline-warning btn-lg btn-block">Voltar</button></a>
        <br>
			<div class="row">
				<div class="col-md-12">
					<h2>Postagens:</h2>
			...
			<div class="row">
				...
				<table class="table">
					...
					<tbody>
						<?php do {?>
						<tr>
							<th scope="row"><?php echo $array['idBlog'];?></th>
							<td><?php echo $array['nomeBlog'];?></td>
							<td>
								<a href="../controller/_del/rem_post.php?id=<?php echo $array['idBlog']?>">Excluir</a><br>
							</td>
						</tr>
