      ...
      <div class="col-sm">
        <div class="card card-signin my-5" >
          <div class="card-body" >
            ...
            <form  enctype="multipart/form-data" class="form-signin" name="cad" action="http://localhost/iHuman/_site/controller/_add/cad_user_2.php" method="POST">
              <div class="form-label-group">
                <input type="text" id="inputNome" class="form-control" placeholder="Nome Completo" name="txt_nome" required autofocus>
                <label for="inputNome">Nome</label>
              </div>

              <div class="form-group">
							<h6 class="card-title text-center">Sou: </h6>
              ...
              <div class="form-label-group">
              <input type="text" id="inputIdade" class="form-control" placeholder="Idade" name="txt_idade" required autofocus>
                <label for="inputIdade">Idade</label>
              </div>

              <div class="form-label-group">
              <input type="text" id="inputTelefone" class="form-control" placeholder="+xx xx xxxxx-xxxx" name="txt_tel" required autofocus>
                <label for="inputTelefone">Telefone</label>
              </div>

              <div class="form-label-group">
              <input type="text" id="inputCpf" class="form-control" placeholder="xxx.xxx.xxx-xx" name="txt_cpf" required autofocus>
                <label for="inputCpf">Cpf</label>
              </div>

              <div class="form-label-group">
              <input type="text" id="inputDef" class="form-control" placeholder="xxx.xxx.xxx-xx" name="txt_def" required autofocus>
                <label for="inputDef">Tipo de Deficiência</label>
              </div>

              <div class="form-label-group">
              <input type="text" id="inputEnd" class="form-control" placeholder="xxx.xxx.xxx-xx" name="txt_end" required autofocus>
                <label for="inputEnd">Endereço</label>
              </div>

              <div class="form-label-group">
              <input type="text" id="inputUf" class="form-control" placeholder="xxx.xxx.xxx-xx" name="txt_uf" required autofocus>
                <label for="inputUf">UF</label>
              </div>

              <div class="form-label-group">
              <input type="text" id="inputGosto" class="form-control" placeholder="xxx.xxx.xxx-xx" name="txt_gostos" required autofocus>
                <label for="inputGosto">Coisas de que gosto</label>
              </div>

              <div class="form-label-group">
              <input type="text" id="inputTutor" class="form-control" placeholder="xxx.xxx.xxx-xx" name="txt_tutor" required autofocus>
                <label for="inputTutor">Nome do meu Tutor(a) *</label>
              </div>

              <div class="form-label-group">
              <input type="email" id="inputEmail" class="form-control" placeholder="xxx.xxx.xxx-xx" name="txt_email" required autofocus>
                <label for="inputEmail">Email</label>
              </div>

              <div class="form-label-group">
                <input type="password" id="inputPassword" class="form-control" placeholder="Password" name="txt_senha" required>
                <label for="inputPassword">Senha</label>
              </div>
              <!-- UPLOAD DE FOTO -->
              <div class="form-label-group">
    						<input type="file" class="form-control-file" name="txt_imagem" accept="image/*" style="background-color: #44A1F2; border-radius: 10px;">
                            <label for="inputFoto">Escolha uma foto de perfil</label>
  			  </div>



              <button class="btn btn-lg btn-light btn-block text-uppercase" type="submit" style="background-color: #F20F8C;">Cadastrar-me</button>
              <hr style="background-color: #fff;">
              <a href="http://localhost/iHuman/_site/view/op_signup.php" class="btn btn-lg btn-light btn-block text-uppercase" style="background-color: yellow;">Voltar</a>
            </form>
          </div>
        </div>
      </div>
