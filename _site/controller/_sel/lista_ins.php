...
$sql = "SELECT * FROM login WHERE class = 4 ORDER BY nome";
//EXECUTA a consulta
                    ...
                    <div class="d-flex justify-content-center" style="margin: 0 5px 0 5px;">
                        <div class="card" style="width: 16rem;">
                            ...
                            <div id="a " class="card-footer" onclick="mudaCor">
                                <a href="#" class="btn btn-primary btn-block align-self-end" style="background-color: #0D0D0D; color: #fff;">
                                <img src="http://localhost/iHuman/_site/media/images/institute.png" alt="" class="img img-responsive" style="width: 2rem;"/>Contatar</a>
                            </div>
                        </div>
                    </div>           
                    <?php
